...
**Core narrative:** SnapStats solves the problem of choosing between watching the game and tracking stats. The workflow is: record the game with any camera, upload the video, then track every stat frame by frame on your desktop with pause, rewind, and precision you'd never get live. Once stats are logged, clicking any stat instantly jumps the video to that exact moment. The app is designed for desktop/laptop use, not mobile courtside tracking. This is a film room tool, not a clipboard replacement.
...
**Job: Hook them in 3 seconds. The pitch: stop choosing between watching the game and tracking stats.**

- Headline (text-4xl mobile, text-5xl desktop, Inter ExtraBold, white):
  "Watch the game. Track it later."
- Subhead (text-lg, slate-300, max-w-2xl):
  "Stop missing the action because you're buried in a clipboard. Just record the game. Upload the video. Then track every stat frame by frame, with pause, rewind, and precision you'd never get live. Click any stat and the video jumps right to that moment. Like magic."
- Primary CTA: "START FREE TRIAL" (lime button, large)
- Secondary CTA: "See How It Works" (ghost button, scrolls to demo section)
- Below CTAs: Small trust line in slate-500, e.g. "No credit card required. 15+ sports supported."
- Visual: A mockup of the desktop app showing a video player on one side and a stat tracking panel on the other. Dark mode UI. Show a fake "pause" state with a stat entry highlighted and a timestamp visible. Use a placeholder div styled as a browser window or desktop frame, not a phone. Make it look like a real product screenshot.
...
**Job: Make it feel dead simple. Emphasize the record-then-track workflow.**

- Section label: "HOW IT WORKS"
- Headline: "Record. Upload. Track. Review."
- 4 steps in a horizontal flow (vertical on mobile):
  1. "Record the Game" — "Point a camera. Phone, tablet, GoPro, whatever you have. Just hit record and watch the game."
  2. "Upload the Video" — "After the game, upload the footage to SnapStats. Pick your team and roster."
  3. "Track Frame by Frame" — "Pause. Rewind. Log every stat with precision you'd never get live. No more missed plays. No more guessing."
...
### 5. The Magic Moment Section

**Job: Sell the killer feature. This is the "wow" moment.**

- Section label: "FILM SYNC"
- Headline: "Click a stat. Watch the play. Instantly."
- Body: "This is the part that changes everything. Once your stats are logged against the video, every single entry is linked to the exact frame it happened. See a goal in your stat sheet? Click it. The video jumps to two seconds before that play. Want to review every turnover in the second half? Click through them one by one. No scrubbing. No hunting. No wasted time. Just click and watch."
- Visual: Build a desktop-style mockup showing a stat list on the left (with clickable rows, one highlighted in lime) and a video player on the right showing a paused frame with a playback timestamp. Include a visible "jump to play" indicator connecting the stat row to the video timecode. Use JetBrains Mono for stat numbers and timestamps. This visual is the most important on the entire page. Make it feel real and impressive.
- Callout badges in a row:
  - "Pause and rewind" in a lime-bordered pill
  - "Frame-by-frame precision" in a lime-bordered pill  
  - "No more missed stats" in a lime-bordered pill
- CTA: "START FREE TRIAL"

### 6. Built for Video Review Section

**Job: Show the desktop tracking experience. This is where the work happens.**

- Section label: "DESKTOP FIRST"
...
- Visual: A wide desktop browser mockup showing the full tracking interface. Left panel: video player with playback controls (play, pause, rewind, frame forward, frame back). Right panel: stat tracking buttons organized by category (Offense: Goal, Assist, Shot on Goal, Turnover / Defense: Steal, Block, Save / General: Foul, Exclusion, Timeout). Show a timeline bar at the bottom with stat markers plotted along it. Build this as a styled component with fake data. Dark mode. Lime highlights on active elements.
- Feature callouts (2 columns on desktop):
  - "Pause and rewind to catch every detail"
  - "Keyboard shortcuts for fast tagging"
  - "Frame-by-frame scrubbing"
  - "Full-screen video with stat overlay"
  - "Instant undo on every entry"
...
- Headline (text-3xl, white): "Stop missing what matters."
...
- Responsive: Desktop (1280px+) is the primary design target. Tablet (768px) and Mobile (375px) should work but the landing page should look its best on desktop since the product itself is desktop-first.
...
2. The solution: Record the game, track stats later from the video with frame-by-frame precision
3. The magic: Click any stat, the video jumps right to that play
4. The breadth: One platform for 15+ sports
5. What to do next: Start free trial

The page should feel fast, athletic, modern, and trustworthy. It should look like it belongs next to Strava or ESPN, not like a template from a website builder. Every mockup should show a desktop browser, not a phone. The product is a film room tool. Every visual should reinforce that.
